// copy from main branch compiled ftl-parser.js
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.peg$parse = exports.BuildInfo = void 0;
/*
...
function peg$parse(input, options) {
    ...
    var peg$FAILED = {}, peg$startRuleIndices = { Start: 0 }, peg$startRuleIndex = 0, peg$consts = [
        ...
        function (id, params) {
            return buildElement('FunctionSignature', {
                name: id,
                params: params
            });
        },
        ...
        function (expr, params) {
            return buildElement('TupleCurrying', {
                expr: expr,
        ...
        peg$literalExpectation(":", false),
        function (id, expr) {
            return buildElement('TupleElement', {
        ...
        function (annotations, expr) {
            return buildElement('MapOperand', {
        ...
        function (first, rest) {
            return buildElement('MapExpression', {
        ...
        function (id, params) {
            return buildElement('OperandFunctionDeclaration', {
                name: id,
                params: params
            });
        },
        function (op, operand) {
            return buildElement('PrefixOperatorDeclaration', {
                operator: op,
                operand: operand
            });
        },
        function (first, rest) {
            return buildElement('InfixOperatorDeclaration', {
                operators: extractList(rest, 1),
                operands: buildList(first, rest, 3)
            });
        },
        function (operand, op) {
            return buildElement('PostfixOperatorDeclaration', {
                operator: op,
                operand: operand
            });
        },
        ...
        peg$decode(";%./ &;*.) &;,.# &;5"),
        peg$decode("%;Z/:#;~/1$;'/($8#:(#! )(#'#(\"'#&'#"),
        peg$decode("%;\"/\x8B#;P.6 &;8.0 &%;n/( 8!:)!\"\" )/i$%;~/J#2*\"\"6*7+/;$;~/2$;P.# &;8/#$+$)($'#(#'#(\"'#&'#.\" &\"/*$8#:,##\"! )(#'#(\"'#&'#"),
        peg$decode("%;)/\x8F#$%;~/D#2-\"\"6-7./5$;~/,$;)/#$+$)($'#(#'#(\"'#&'#0N*%;~/D#2-\"\"6-7./5$;~/,$;)/#$+$)($'#(#'#(\"'#&'#&/)$8\":/\"\"! )(\"'#&'#"),
        peg$decode("%%;\"/0#;T/'$8\":0\" )(\"'#&'#/p#;~/g$21\"\"6172/X$;~/O$;'.\" &\"/A$;~/8$23\"\"6374/)$8':5'\"&\")(''#(&'#(%'#($'#(#'#(\"'#&'#"),
        peg$decode(";(.# &;&"),
        peg$decode("%;\\.# &;[/f#;~/]$;P/T$;~/K$26\"\"6677/<$;~/3$;7/*$8':8'#&$ )(''#(&'#(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%;P/;#;~/2$;-/)$8#:9#\"\" )(#'#(\"'#&'#"),
        peg$decode("%;V/S#;~/J$;<.# &;+/;$;~/2$;1/)$8%::%\"\" )(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%2;\"\"6;7</W#;~/N$;/.\" &\"/@$;~/7$2=\"\"6=7>/($8%:?%!\")(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%;-/e#$%;~/,#;-/#$+\")(\"'#&'#/9#06*%;~/,#;-/#$+\")(\"'#&'#&&&#/)$8\":@\"\"! )(\"'#&'#"),
        peg$decode("%;0/\x8F#$%;~/D#2-\"\"6-7./5$;~/,$;0/#$+$)($'#(#'#(\"'#&'#0N*%;~/D#2-\"\"6-7./5$;~/,$;0/#$+$)($'#(#'#(\"'#&'#&/)$8\":A\"\"! )(\"'#&'#"),
        peg$decode("%%;P/;#;~/2$2B\"\"6B7C/#$+#)(#'#(\"'#&'#.\" &\"/;#;~/2$;4/)$8#:D#\"\" )(#'#(\"'#&'#"),
        peg$decode(";N.b &%$%;3/,#;~/#$+\")(\"'#&'#/9#06*%;3/,#;~/#$+\")(\"'#&'#&&&#/' 8!:E!! )"),
        peg$decode("%$%;6/,#;~/#$+\")(\"'#&'#06*%;6/,#;~/#$+\")(\"'#&'#&/8#;@.# &;7/)$8\":F\"\"! )(\"'#&'#"),
        peg$decode("%2G\"\"6G7H/:#;~/1$;2/($8#:I#! )(#'#(\"'#&'#"),
        peg$decode("%;2/_#$%;~/,#;3/#$+\")(\"'#&'#06*%;~/,#;3/#$+\")(\"'#&'#&/)$8\":J\"\"! )(\"'#&'#"),
        peg$decode("%;4/' 8!:K!! )"),
        peg$decode("%2L\"\"6L7M/7#;L.# &;P/($8\":N\"! )(\"'#&'#"),
        peg$decode(";G.Y &;F.S &;M.M &;L.G &;K.A &;P.; &;H.5 &;../ &;-.) &;E.# &;A"),
        peg$decode("%%<2O\"\"6O7P=.##&&!&'#/]#%<2G\"\"6G7H=.##&&!&'#/B$;a/9$$;a0#*;a&/)$8$:Q$\"! )($'#(#'#(\"'#&'#"),
        peg$decode("%;P/' 8!:R!! )"),
        peg$decode("%;P/2#;-/)$8\":S\"\"! )(\"'#&'#"),
        peg$decode(";:.# &;9"),
        peg$decode(";=.) &;>.# &;?"),
        peg$decode("%;8/;#;~/2$;;/)$8#:T#\"\" )(#'#(\"'#&'#"),
        peg$decode("%;;/\x89#$%;~/>#;8/5$;~/,$;;/#$+$)($'#(#'#(\"'#&'#/K#0H*%;~/>#;8/5$;~/,$;;/#$+$)($'#(#'#(\"'#&'#&&&#/)$8\":U\"\"! )(\"'#&'#"),
        peg$decode("%;;/;#;~/2$;8/)$8#:V#\"\" )(#'#(\"'#&'#"),
        peg$decode("%;D.# &;B/' 8!:W!! )"),
        peg$decode("%;8/;#;~/2$;7/)$8#:X#\"\" )(#'#(\"'#&'#"),
        peg$decode("%;7/;#;~/2$;8/)$8#:Y#\"\" )(#'#(\"'#&'#"),
        peg$decode(";7.] &%2;\"\"6;7</M#;~/D$;B/;$;~/2$2=\"\"6=7>/#$+%)(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%;C/\xAB#$%;~/>#;8/5$;~/,$;C/#$+$)($'#(#'#(\"'#&'#/K#0H*%;~/>#;8/5$;~/,$;C/#$+$)($'#(#'#(\"'#&'#&&&#/K$%;~/,#;8/#$+\")(\"'#&'#.\" &\"/*$8#:Z##\"! )(#'#(\"'#&'#"),
        peg$decode("%2[\"\"6[7\\/k#2]\"\"6]7^.R &%;h/H#$;`0#*;`&/8$%<;R=.##&&!&'#/#$+#)(#'#(\"'#&'#/'$8\":_\" )(\"'#&'#"),
        peg$decode("%;P/;#;~/2$;H/)$8#:`#\"\" )(#'#(\"'#&'#"),
        peg$decode(";c./ &;d.) &;e.# &;n"),
        peg$decode("%21\"\"6172/a#%;~/,#;I/#$+\")(\"'#&'#.\" &\"/@$;~/7$23\"\"6374/($8$:a$!\")($'#(#'#(\"'#&'#"),
        peg$decode("%;J/\x8F#$%;~/D#2-\"\"6-7./5$;~/,$;J/#$+$)($'#(#'#(\"'#&'#0N*%;~/D#2-\"\"6-7./5$;~/,$;J/#$+$)($'#(#'#(\"'#&'#&/)$8\":b\"\"! )(\"'#&'#"),
        peg$decode(";@.# &;7"),
        peg$decode("%;P/r#;~/i$21\"\"6172/Z$;~/Q$$;//&#0#*;/&&&#/;$;~/2$23\"\"6374/#$+')(''#(&'#(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%;P/E#%;~/,#;-/#$+\")(\"'#&'#/)$8\":c\"\"! )(\"'#&'#"),
        peg$decode("%;L/e#$%;~/,#;-/#$+\")(\"'#&'#/9#06*%;~/,#;-/#$+\")(\"'#&'#&&&#/)$8\":d\"\"! )(\"'#&'#"),
        ...
        peg$decode("2]\"\"6]7^.Q &%4\x8F\"\"5!7\x90.\" &\"/<#;h/3$$;`0#*;`&/#$+#)(#'#(\"'#&'#"),
        ...
        peg$decode("<;}.# &;|=.\" 7\xC4"),
        peg$decode("%2O\"\"6O7P/q#$%%<;x=.##&&!&'#/,#;O/#$+\")(\"'#&'#0B*%%<;x=.##&&!&'#/,#;O/#$+\")(\"'#&'#&/#$+\")(\"'#&'#"),
    ...
    function peg$parseRule(index) {
        ...
        var key = peg$currPos * 97 + index, cached = peg$resultsCache[key];
        if (cached) {
