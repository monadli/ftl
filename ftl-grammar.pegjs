...
// NamespaceIdentifier is for ftl path or ftl file name
// which starts with a lower case character followed by lower case character or `_` or digit.
NamespaceIdentifier =
  !ReservedWord name:(first:LowerLetter rest:(LowerLetter / "_" / DecimalDigit)* {
    return first + rest.join("")
  })
  {
